...
namespace ContosoUniversity8_22.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            /*The second Include method loads Courses, and for each Course that is loaded 
            it does eager loading for the Course.Department navigation property. */
            ...
            string[] selectedCourses)
        {
            ...
            if (selectedCourses != null)
            {
                ...
                {
                    var courseToAdd = db.Courses.Find(int.Parse(course)); instructor.Courses.Add(courseToAdd);
                }
            }
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Instructor instructor = db.Instructors
                ...
                .Include(i => i.Courses).Where(i => i.ID == id).Single();
            PopulateAssignedCourseData(instructor);
            if (instructor == null)
            {
                return HttpNotFound();
        ...
        private void PopulateAssignedCourseData(Instructor instructor)
        {
             ...
             * the courses assigned to the instructor are put into a HashSet collection. The Assigned property  
             * is set to true  for courses the instructor is assigned. */
